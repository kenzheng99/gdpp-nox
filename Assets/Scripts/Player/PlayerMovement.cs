...
public class PlayerMovement : MonoBehaviour
{
	...
	private void Update()
	{
		...
		_anim.SetBool("isJumping", LastOnGroundTime <= 0);
		_anim.SetBool("isCrouching", isChargingJump);
		_anim.SetBool("isOnWall", LastOnWallTime > 0);
		_anim.SetBool("isWallJumping", IsWallJumping);
